...
| Conversation memory | standalone | internal (feeds `MasterAdapter.narrate`/`interpret` via `recentConversation`, no dedicated route) | ConversationMemoryServiceImpl.java, ConversationTurn.java | — |
